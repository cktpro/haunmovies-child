					...
					if ($day->have_posts()):
						while ($day->have_posts()):
							...
							<div class="item post-<?php echo $post_id; ?>">
								<a class="thumbnail-link" title="<?php echo esc_attr($title); ?>"
									href="<?php echo esc_url($permalink); ?>" rel="bookmark">
									<div class="item-link">
										<img width="65" height="80" src="<?php echo esc_url($thumbnail); ?>"
											alt="<?php echo esc_attr($title); ?>" class="wp-post-image img-responsive">
									</div>
